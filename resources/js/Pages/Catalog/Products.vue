<template>
  <div class="text-on-surface min-h-screen pb-24 lg:pb-0" style="background-color: #faf9f6;">
    ...
    <!-- Main Content -->
    <main class="pt-6 lg:pt-28 pb-32 lg:pb-12 px-4 md:px-6 max-w-7xl mx-auto">
